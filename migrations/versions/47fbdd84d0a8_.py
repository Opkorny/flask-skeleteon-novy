...
Revision ID: 47fbdd84d0a8
Revises: None
Create Date: 2019-10-09 10:22:01.293493

"""

# revision identifiers, used by Alembic.
revision = '47fbdd84d0a8'
down_revision = None
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id', name='pk_vozidlo'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_vozidlo_spz', 'vozidlo', ['spz'], unique=True)
    op.create_index('ix_vozidlo_typ', 'vozidlo', ['typ'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_vozidlo_typ', table_name='vozidlo')
    op.drop_index('ix_vozidlo_spz', table_name='vozidlo')
